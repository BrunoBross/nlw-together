...
export function Room(){
  ...
  return(
    <div id="page-room">
      ...
      {/* VERIFICAR SE A SALA ESTA ENCERRADA */}
      {!endedAt && (
        <main>
              ...
              return (
                ...
                > 
                  ...
                  {!question.isAnswered && user?.id === authorId && (
                    <> 
                      <ButtonQuestion
                        handleFunction={handleCheckQuestionAsAnswered}
                        image={checkImg}
                        question={question}
                      />

                      <ButtonQuestion
                        handleFunction={handleHighlightedQuestion}
                        image={answerImg}
                        question={question}
                      />
                    </>
      ...
      {endedAt && (
        <main>
          <h1>A sala "{title}" foi encerrada</h1>
